...
from zsp.datasets.co3d_tools.camera_utils import assert_pytorch3d_has_new_ndc_convention
from zsp.datasets import co3d_types as types
...
class Co3dDataset(torch.utils.data.Dataset):
    ...
    def _get_pytorch3d_camera(self, entry, scale, clamp_bbox_xyxy):
        ...
        if self.image_height is None or self.image_width is None:
            if self.box_crop:
                # print('Calling fixed part of dataset method')
                out_size = [clamp_bbox_xyxy[2]-clamp_bbox_xyxy[0], 
